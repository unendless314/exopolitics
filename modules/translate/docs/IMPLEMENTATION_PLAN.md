...
5. **Mock LLM Execution**: Mock API responses to test successful transitions to `completed` and failure paths to `failed` (verifying `retry_count` incrementing and locking at 3).
