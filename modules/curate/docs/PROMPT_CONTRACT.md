...
- editor_brief: Provide internal guidance for downstream editors or rewrite tasks. You must populate the following fields:
  ...
  - target_format: Set to the intended final format to rewrite into or publish:
