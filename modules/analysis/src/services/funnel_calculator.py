...
class FunnelCalculator:
    ...
    def run_funnel_analysis(self, days: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "raw_metrics": {
                ...
                "low_context_bypass_count": raw_readiness["low_context_bypass"],
                ...
                "classification_readiness_breakdown": {
                    "low_context_bypass": raw_readiness["low_context_bypass"],
                    "total_classified": raw_readiness["total_classified"],
            ...
            "matured_metrics": {
                ...
                "low_context_bypass_count": matured_readiness["low_context_bypass"],
                ...
                "classification_readiness_breakdown": {
                    "low_context_bypass": matured_readiness["low_context_bypass"],
                    "total_classified": matured_readiness["total_classified"],
    ...
    def format_markdown_report(self, data: Dict[str, Any]) -> str:
        ...
        lines = [
            ...
            f"- **Low-Context Bypass**: {raw_m['low_context_bypass_count']}",
            ...
            f"- **Completed & Classified**: {raw_m['classification_readiness_breakdown']['total_classified']}",
            f"- **Low-Context Bypass**: {raw_m['classification_readiness_breakdown']['low_context_bypass']}",
            ...
            f"- **Low-Context Bypass**: {matured_m['low_context_bypass_count']}",
            ...
            "",
            "### Ingestion Cohort Readiness Breakdown",
            f"- **Completed & Classified**: {matured_m['classification_readiness_breakdown']['total_classified']}",
            f"- **Low-Context Bypass**: {matured_m['classification_readiness_breakdown']['low_context_bypass']}",
