...
def test_translate_service_with_mock_data(empty_db_conn):
    ...
    # keeping the 0-or-3 bullet invariant consistent)
    conn.execute("""
    ...
    # Approved content record: title length = 22, summary length = 12,
    # bullets NULL -> five-field total = 34
    conn.execute("""
    ...
    """, [
        (501, 301, "zh", "中文標題", "中文內容", None, None, None, "fp-301", "completed", "test-translator", "v1.0", "2026-07-10T11:00:00Z", "2026-07-10T11:00:00Z"),
        (501, 301, "ja", None, None, None, None, None, "fp-301", "failed", "test-translator", "v1.0", None, "2026-07-10T11:00:00Z")
    ])
