...
DDL_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS source_item_text (
        ...
        text_processing_reason TEXT CHECK (text_processing_reason IS NULL OR text_processing_reason IN ('post_cleanup_empty', 'too_short', 'title_only', 'title_heavy', 'template_heavy', 'mostly_links', 'truncated_to_low_context', 'missing_body', 'sanitizer_exception')),
