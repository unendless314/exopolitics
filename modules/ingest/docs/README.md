...
- `ingest` does not filter out old/historical items by date; all fetched unique items are stored. Downstream time-filtering responsibilities are governed by the top-level [DATA_LIFECYCLE.md](file:///C:/Users/user/Documents/exopolitics/docs/DATA_LIFECYCLE.md#11-temporal-policy-and-historical-data) policy.
